...
function getModel() {
    ...
    model.add(tf.layers.conv2d({inputShape: [28, 28, 1], kernelSize: 5, filters: 16, activation: 'relu'}));
...
async function train(model, data) {
    ...
    //const metrics = ['loss', 'val_loss', 'accuracy', 'val_accuracy']; this line didn'twork well: it has displayed only validation loss, not accuracy!  The line above instead worked well!
